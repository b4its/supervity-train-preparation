...
Rules:
- Read the case artifact from Dropbox cases/CASE-<case_key>.json.
...
- Write CASE-<case_key>-data-quality.md to Dropbox cases/ with the evidence index, matching record IDs, data-quality flags, and any Supabase query results.
- Append Data Quality section to the existing CASE-<case_key>.json in Dropbox.
